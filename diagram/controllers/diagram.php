...
class Diagram extends MX_Controller {
	...
	public function toolbar(){
		$data["toolbar_menu"] = $this->config->item("toolbar_menu");
		$this->load->vars($data);
		$this->load->view("toolbar_view");
	}	
	public function pain_toolbar(){
		$data["toolbar_menu"] = $this->config->item("pain_color");
		$this->load->vars($data);
		$this->load->view("pain_toolbar_view");
	}
	
	public function view($id=null,$pid=null,$mode=null,$ans_id=null,$repid=null){
